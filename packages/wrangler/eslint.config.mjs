...
export default defineConfig([
	...
	// Enforce using waitFor/waitForLong helpers instead of bare vi.waitFor in e2e tests
	{
		files: ["e2e/**/*.ts"],
		...
		rules: {
			"no-restricted-syntax": [
				"error",
				{
					...
					message:
						"Use waitFor() or waitForLong() from './helpers/wait-for' instead of vi.waitFor().",
				},
			],
		},
	},
